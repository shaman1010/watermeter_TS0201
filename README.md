...
Используется готовый термометр/гигрометр от Tuya - TS0201. Подключение проводов от счетчика - к земле.

<img src="https://github.com/shaman1010/watermeter_TS0201/blob/main/doc/images/module_pinout.jpg"/>
---
...
Прошивка собирается легко в Линуксе, подключается файл платы `board_8258_diy.h`. Еще адаптирована плата dongle, т.е. `board_8258_dongle.h`. Для других вариантов придется самостоятельно редактировать файл нужной платы.
